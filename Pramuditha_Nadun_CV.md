...
**TECHNICAL SKILLS**
* **Frontend:** React, TypeScript, JavaScript, React Hooks & Forms, Redux, Ant Design (AntD), HTML, CSS
* **Backend & Databases:** Spring Boot, Java, FastAPI, Python, PostgreSQL, Oracle Forms, Jasper Reports
* **DevOps & Infrastructure:** Docker, Git (commands & tagging), Jenkins, ArgoCD, Celery, Redis, AWS S3 / MinIO
* **Design & UI/UX:** Figma, Wireframing, Adobe Creative Suite (Photoshop, Illustrator, Premiere Pro, After Effects)
* **Data & Analytics:** XGBoost, GRU, ARIMA, Variational Mode Decomposition (VMD), FinBERT

**PROFESSIONAL EXPERIENCE**

**LOLC Technologies** | Associate Software Engineer (Fusion X Team)
*Hybrid | 2024 - Present*
...
**LOLC Technologies** | Trainee Software Engineer (Fusion Team)
*Hybrid | Mar 2022 - Oct 2024*
...
**11LabsM - Neural Voice Synthesizer & Translator** | *React, FastAPI, Celery, Redis, PostgreSQL, Docker*
...
**Brent Crude Oil Forecasting System** | *Python, XGBoost, GRU, ARIMA, VMD*
...
University of Westminster, UK | Feb 2022 - 2026
